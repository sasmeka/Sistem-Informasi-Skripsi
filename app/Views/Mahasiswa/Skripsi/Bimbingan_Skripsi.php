...
<div class="container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Bimbingan</h4><span class="text-muted mt-1 tx-13 ms-2 mb-0">/ Skripsi</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    <div class="modal" id="modaladd">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="<?= base_url() ?>tambah_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                ...
                <div class="main-content-left main-content-left-chat">
                    <div class="main-chat-list" id="ChatList">
                        ...
                        foreach ($dosen_pembimbing as $key2) {
                            ...
                            $notif = $db->query("SELECT *, COUNT( * ) AS total FROM tb_bimbingan WHERE status_baca='belum dibaca' AND `from`='$key2->nip' AND `to`='" . session()->get('ses_id') . "' AND kategori_bimbingan=3 GROUP BY `from`")->getResult();
                        ?>
                            <a href="<?= base_url() ?>bimbingan_skripsi/<?= $key2->nip ?>">
                                <?php if ($notif != NULL) { ?>
                                    <div class="media new">
                                    <?php } else {
                                    ?>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="main-msg-wrapper left">
                                                ...
                                                <?php if ($key->berkas != NULL) { ?>
                                                    <hr>
                                                    <form action="<?= base_url() ?>download_berkas_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
                                                        <?= csrf_field() ?>
                                                        <input type="hidden" name="id_bimbingan" value="<?php echo $key->id_bimbingan; ?>" />
                                ...
                                <div class="modal" id="modaldel<?= $key->id_bimbingan ?>">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content modal-content-demo">
                                            ...
                                            <form action="<?= base_url() ?>hapus_bimbingan_skripsi" method="POST" enctype="multipart/form-data">
                                                <?= csrf_field() ?>
                                                <input type="hidden" name="id_bimbingan" value="<?php echo $key->id_bimbingan; ?>" />
