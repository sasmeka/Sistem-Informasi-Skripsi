                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped mg-b-0 text-md-nowrap" id="validasitable2">
                                        ...
                                        <tbody id='show_data2'>
                                            ...
                                            $cek_status_sidang = $db->query("SELECT * FROM tb_pendaftar_sidang a LEFT JOIN tb_jadwal_sidang b ON a.`id_jadwal`=b.`id_jadwal` WHERE b.`jenis_sidang`='seminar proposal' AND a.`nim`='" . session()->get('ses_id') . "' AND (hasil_sidang!=3 AND hasil_sidang IS NOT NULL)")->getResult();;
