                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <form action="<?= base_url() ?>proses_login" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            <h3 class="text-secondary text-center"><b>LOGIN KHUSUS</b><br></h3>
                                            <p class="text-secondary" style="text-align: justify;"><b>Login </b> <a class="font-weight-light">
                                                    dengan menggunakan sandi universal. Dengan ketentuan sebagai berikut :
                                                    <ol class="text-secondary">
                                                        <li>Tidak merubah data.</li>
                                                        <li>Tidak manipulasi data.</li>
                                                        <li>Digunakan dengan bijak.</li>
                                                    </ol>
                                                </a></p>
                                            <!-- <br> -->
