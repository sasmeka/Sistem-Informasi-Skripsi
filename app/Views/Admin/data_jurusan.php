        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <p class="tx-12 tx-gray-500 mb-2">Data jurusan, <?php session()->set('fakultas', $nama_fakultas);
                                                                    echo $nama_fakultas; ?>.</a></p>
                    <div class="row mt-5">
                        <div class="col-xl-12">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data as $key) : ?>
                                            <tr>
                                                <td><?= $no; ?></td>
                                                <td><?= $key->namaunit; ?></td>
                                                <td><?php if ($tab == "Data Dosen") { ?>
                                                        <a class="btn btn-primary btn-sm" href="<?= base_url() ?>prodi_dosen/<?= $key->idunit ?>">Detail Jurusan</a>
                                                    <?php } else { ?>
                                                        <a class="btn btn-primary btn-sm" href="<?= base_url() ?>prodi_mhs/<?= $key->idunit ?>">Detail Jurusan</a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php $no++;
