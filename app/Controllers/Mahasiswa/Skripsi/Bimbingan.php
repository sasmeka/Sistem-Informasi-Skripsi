...
class Bimbingan extends BaseController
{
    ...
    public function tambah()
    {
        ...
        if ($berkas->getName() != '') {
            ...
            $this->db->query("INSERT INTO tb_bimbingan (`from`,`to`,status_baca,keterangan,pokok_bimbingan,create_at,kategori_bimbingan) VALUES('" . session()->get('ses_id') . "','$pembimbing','belum dibaca','$keterangan','$pokok_bimbingan',now(),3)");
            $this->db->query("INSERT INTO tb_log (user,`action`,`log`,date_time) VALUES ('" . session()->get('ses_id') . "','Bimbingan','Bimbingan kepada pembimbing $pembimbing',now())");
        }
        return redirect()->to("/bimbingan_skripsi/$pembimbing");
    }
    public function hapus()
    {
        ...
        return redirect()->to("/bimbingan_skripsi/$nip");
    }
